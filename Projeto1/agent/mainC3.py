        ...
        while True:
            ...
            if f:
                ...
                if state == 'run':
                    ...
                    beacons_permutations = list(itertools.permutations(list(beac), len(beac)))
                    all_permutations = []
                    for i in beacons_permutations:
                        temp = [(0, 0)]
                        for j in i:
                            temp.append(j)
                        temp.append((0, 0))
                    ...
                    self.path_to_file(shortest_path)
                    self.finish()
